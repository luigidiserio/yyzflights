            ...
            {searchResults && (
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-gray-900">
                  Flight Results ({searchResults.total_results} found)
                </h3>
                            ...
                            <div className="flex items-center space-x-6">
                              <div className="text-center">
                                <div className="font-bold text-lg">
                                  {formatTime(flight.segments[0].departure_at)}
                                </div>
                                <div className="text-sm text-gray-600">
                                  {flight.segments[0].origin}
                                </div>
                                <div className="text-xs text-gray-500">
                                  {formatDate(flight.segments[0].departure_at)}
                                </div>
                              </div>
                              ...
                              <div className="flex-1 text-center">
                                ...
                                <div className="border-t border-gray-300 relative">
                                  <Plane className="absolute top-[-8px] left-1/2 transform -translate-x-1/2 w-4 h-4 text-blue-500 bg-white" />
                                </div>
                              ...
                              <div className="text-center">
                                <div className="font-bold text-lg">
                                  {formatTime(flight.segments[0].arrival_at)}
                                </div>
                                <div className="text-sm text-gray-600">
                                  {flight.segments[0].destination}
                                </div>
                                <div className="text-xs text-gray-500">
                                  {formatDate(flight.segments[0].arrival_at)}
                                </div>
                              </div>
                            </div>
                          </div>
